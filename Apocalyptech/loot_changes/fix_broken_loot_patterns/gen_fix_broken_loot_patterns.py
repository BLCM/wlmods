...
for label, bpchar, new_time in [
        ...
        ('Knight Mare (runnable)',
            ...
            1),
        ('Zomboss (plot)',
            '/Game/Enemies/BoneArmy/_Unique/ZombieQueen/_Design/Character/BPChar_BoneArmy_ZombieQueen',
            1),
        ('Zomboss (runnable)',
            '/Game/Enemies/BoneArmy/_Unique/ZombieQueen/_Design/Character/BPChar_BoneArmy_ZombieQueen_Runnable',
            1),
        ]:
