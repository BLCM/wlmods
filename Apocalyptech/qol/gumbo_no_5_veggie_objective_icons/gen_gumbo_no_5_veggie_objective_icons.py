...
mod = Mod('gumbo_no_5_veggie_objective_icons.wlhotfix',
        'Gumbo No. 5: Veggie Objective Icons',
        'Apocalyptech',
        [
        ...
        ss='https://raw.githubusercontent.com/BLCM/wlmods/main/Apocalyptech/qol/gumbo_no_5_veggie_objective_icons/crying_apples.jpg',
        )

map_base = '/Game/Maps/Zone_3/Oasis/Oasis_M_LowTideBoil'
...
for export in map_data:
    if export['export_type'] == 'IO_MissionDamageable_ButtslamVeggies_C':
        ...
        #            waypoint,
        #            )
        mod.reg_hotfix(Mod.EARLYLEVEL, 'Oasis_P',
                damageable_name_full,
