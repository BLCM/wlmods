...
# https://docs.google.com/spreadsheets/d/1m8rFzQLta5iKF1pYXDj_AwcHFt-NpnAQ__Efmwhtw1s/edit?usp=sharing
...
# URL Block
url_paragraphs = [
        ("""The code which generated this sheet can be found here:""",
        'https://github.com/BLCM/wlmods/blob/master/Apocalyptech/dataprocessing/gen_item_balances.py'),
